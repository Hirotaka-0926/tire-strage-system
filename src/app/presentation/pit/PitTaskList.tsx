...
import { createPitTaskApplication } from "@/app/application/pit/pitTaskApplication";
import { PitFilterStatus, PitTask, PitTaskInput } from "@/app/domain/type/pit";
import PitStatusCards from "@/app/presentation/pit/components/PitStatusCards";
import PitTaskTable from "@/app/presentation/pit/components/PitTaskTable";
import PitMaintenanceDialog from "@/app/presentation/pit/components/PitMaintenanceDialog";
import PitAssignStorageDialog from "@/app/presentation/pit/components/PitAssignStorageDialog";
import PitSaveTaskDialog from "@/app/presentation/pit/components/PitSaveTaskDialog";
import PitDeleteTaskDialog from "@/app/presentation/pit/components/PitDeleteTaskDialog";
...
const PitTaskList = ({ tasks }: PitTaskListProps) => {
  ...
  const [selectedStorageTask, setSelectedStorageTask] =
    useState<PitTaskInput | null>(null);
  const [selectedSaveTask, setSelectedSaveTask] = useState<PitTaskInput | null>(
    null,
  );
