...
import { createStorageDetailApplication } from "@/app/application/storage/storageDetailApplication";
...
import { getYearAndSeason } from "@/app/domain/service/common/globalFunctions";
...
interface DetailPanelProps {
  ...
  onUpdateFromHistory: (slotId: string, updates: Partial<StorageSlot>) => void;
...
export const DetailPanel = ({
  ...
  const getStatusText = (storage: StorageSlot) => {
    const isOccupied =
      storage.car_id !== null ||
  ...
  const getStatusColor = (storage: StorageSlot) => {
    const isOccupied =
      storage.car_id !== null ||
      storage.client_id !== null ||
      storage.tire_state_id !== null;
  ...
  useEffect(() => {
    ...
    fetchStorageData();
  }, [selectedSlot, storageDetailApplication]);
