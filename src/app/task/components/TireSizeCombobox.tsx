...
import { getTireSizesFromPrice } from "@/utils/supabaseFunction";
...
const TireSizeCombobox = ({ value, onChange, disabled, label = "タイヤサイズ" }: Props) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        setLoading(true);
        const list = await getTireSizesFromPrice();
...
export default TireSizeCombobox;
