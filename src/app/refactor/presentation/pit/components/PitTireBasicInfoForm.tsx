...
import PitTireMakerCombobox from "@/app/refactor/presentation/pit/components/PitTireMakerCombobox";
import PitTirePatternCombobox from "@/app/refactor/presentation/pit/components/PitTirePatternCombobox";
import PitTireSizeCombobox from "@/app/refactor/presentation/pit/components/PitTireSizeCombobox";
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updateField("manufacture_year", parseInt(e.target.value, 10) || 0)
              }
              disabled={loading}
            />
          </div>
