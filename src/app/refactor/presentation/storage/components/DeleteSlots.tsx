...
import { createStorageSlotManagementApplication } from "@/app/refactor/application/storage/storageSlotManagementApplication";
                  ...
                  {selectedArea && targetCount && (
                    <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3">
                      <p className="text-sm text-yellow-800">
                        ...
                        {areas.find((a) => a.name === selectedArea)?.totalSlots || 0}
                        個から{targetCount}個に調整します。
                        {parseInt(targetCount, 10) <
                          (areas.find((a) => a.name === selectedArea)?.totalSlots ||
                            0) && (
                          <span className="mt-1 block text-red-600">
                            注意:
                            {(areas.find((a) => a.name === selectedArea)?.totalSlots ||
                              0) - parseInt(targetCount, 10)}
